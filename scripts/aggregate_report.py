...
def aggregate(results_root: Path = Path("results")) -> Path:
    ...
    html = [
        ...
        "<div class='section'><h2>Executive summary</h2><p>This report benchmarks forecasting and integrated agentic-policy models for slice-aware RAN scheduling/resource actions across eMBB, MTC, and URLLC.</p></div>",
